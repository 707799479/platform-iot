...
<div class="hui-wrap">
  ...
  <div class="hui-speed-dial">
    <div class="hui-img-list-content">
      <h1>
        <span>状态：<span style="color: red;">${phoneCard.cid == null?'停机':'使用中'}</span></span>
    ...
    <ul>
      ...
      <li onclick="tiao('query')">
        ...
        <div class="hui-speed-dial-text">信息查询</div>
      </li>
      <%--<li onclick="tiao('gofreecard')">
        <div class="hui-speed-dial-icons">
          <span class="hui-icons hui-icons-insert"></span>
        </div>
        <div class="hui-speed-dial-text">免费补卡</div>
      </li>--%>


      <li onclick="tiao('feedbackList')" >
        <c:if test="${feedCount!=0}"><span style="position: fixed; " class="hui-badge hui-danger">${feedCount}</span></c:if>
        <div class="hui-speed-dial-icons">

          <span class="hui-icons hui-icons-toast"></span>
        </div>
        <div class="hui-speed-dial-text">故障卡号</div>
      </li>
      <li>
        <div class="hui-speed-dial-icons">
          <span class="hui-icons hui-icons-action-sheet"></span>
        </div>
        <div class="hui-speed-dial-text">未开放</div>
      </li>
      <li>
        <div class="hui-speed-dial-icons">
          <span class="hui-icons hui-icons-action-sheet"></span>
