...
<div class="wrapper">
  <div class="left-nav">
    <div id="side-nav">
      <ul id="nav">
        ...
        <li  class="current"> <a href="/admin/updatePassword"> <i class="icon-cogs"></i>修改密码</a> </li>
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">修改密码<small>定期修改密码账户更安全</small></h2>
        </div>
      </div>
      <div class="row">
        <div class="widget">
              ...
              <div class="body">
				...
				<div class="form-group">
				  ...
				  <div class="input-group" style="width:100%;">
                    ...
                    <a class="btn btn-s-md btn-default" href="javascript:save();">确认修改</a>
                </form>
                </div>
              </div>
