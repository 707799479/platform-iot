...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">添加实时资费<small>在这里您可以尽情的添加</small></h2>
                </div>
            </div>
                    ...
                    <div class="widget-content">
                        <div class="body">
                            ...
                            <div class="form-group">
                                <label for="search-input">资费内容：</label>
                                <div class="input-group" style="width:100%;">
                                    <textarea class="form-control" rows="3" id="note" >${note}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group" style="width:100%;">
                                    <input type="number" id="sort" value="${sort}" class="form-control">
...
<script type="text/javascript">
    function save() {
        var note = $("#note").val();
        var sort = $("#sort").val();
        if(note.length < 1 || sort.length < 1){
            alert("请完善内容再保存");
            return;
        }
        var id = $("#id").val();
        if(id == '' || id == null){
            window.location.href = "/admin/saveCost?name="+name+"&note="+note+"&sort="+sort;
        }else{
            window.location.href = "/admin/saveCost?name="+name+"&note="+note+"&sort="+sort+'&id='+id;
        }
