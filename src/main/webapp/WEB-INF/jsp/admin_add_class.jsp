...
<div class="wrapper">
            ...
            <ul id="nav">
                ...
                <li> <a href="#"> <i class="icon-edit"></i>套餐管理<i class="arrow icon-angle-left"></i></a>
                    <ul class="sub-menu">
                        ...
                        <li class="current"> <a href="/admin/addClass"> <i class="icon-angle-right"></i>添加分类</a> </li>
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">卡分类<small>您可以在这里设置卡分类</small></h2>
                </div>
            </div>
                    ...
                    <div class="widget-content">
                        <div class="body">
                            ...
                            <div class="form-group">
                                ...
                                <a style="width: 100%;" class="btn btn-s-md btn-default" href="javascript:save()">添加</a>
                            </c:if>
                            <c:if test="${user_agent.parentId != 0}">
                                <h1> 您还没有此权限</h1>
                            </c:if>
...
<script type="text/javascript">
    function save() {
        var name = $("#name").val();
        var sort = $("#sort").val();
        if(name.length < 1 || sort.length < 1){
            alert("请完善内容再保存");
            return;
        }
        window.location.href = "/admin/addClass?name="+name+"&sort="+sort;
    }
</script>