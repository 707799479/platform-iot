...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">实时资费<small>您可以在这里设置实时资费</small></h2>
                </div>
            </div>
            <div class="row">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="body">
                            ...
                            <br>
                            <a style="width: 100%;" class="btn btn-s-md btn-default" href="javascript:addCost()">添加一个实时资费</a> <br>
...
<script type="text/javascript">
    ...
    function edit(id){
        for(var i = 0;i<requestJson.length;i++){
            if(requestJson[i].id == id){
                window.location.href='/admin/saveCost?j=1&id='+id+'&note='+requestJson[i].note+'&sort='+requestJson[i].sort;
            }
        }
    }
    //删除
    function deletes(id) {
        if(confirm("确定要删除吗？")){
            $.post("/admin/deleteCost",{id:id},function(result){
                if(result == 1){
    ...
    function addCost(){
        if(requestJson.length < 1){
            window.location.href='/admin/saveCost?sort=1&j=1';
            return;
        }
        var sort = requestJson[requestJson.length-1].sort;
        window.location.href='/admin/saveCost?j=1&sort='+(sort+1);
    }
