  ...
  <body>
    <div class="page login-page">
            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  ...
                  <p>您可以在这里登录后台，并管理旗下代理。以及网站的维护管理~</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
                ...
                <div class="content">
                  <form action="/admin/login" method="post" class="form-validate">
                    ...
                    <div class="form-group">
                      ...
                      <br>
                      <p>${login_title}</p>
                    </div><input type="submit" value="登入" class="btn btn-primary">
                    <!-- This should be submit button but I replaced it with <a> for demo purposes-->
                  </form><a href="#" class="forgot-pass">还没有账号？</a><br><small>点这里申请一个? </small><a href="reg" class="signup">成为代理</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="copyrights text-center">
        <p>由最新大数据平台提供技术支持<a href="#" class="external">Big data</a>
