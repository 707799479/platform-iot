...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">反馈回复<small>在这里进行回复</small></h2>
                </div>
            </div>
                    ...
                    <div class="widget-content">
                        <div class="body">
                            <div class="form-group">
                                <label for="search-input">反馈卡号：</label>
                            ...
                            <div class="form-group">
                                <label for="search-input">卡说明：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${notice}</p>
                                    <span class="input-group-btn">
                                  </span>
                            ...
                            <div class="form-group">
                                <label for="search-input">已用流量：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${data}</p>
                                    <span class="input-group-btn">
                                  </span>
                            ...
                            <div class="form-group">
                                <label for="search-input">总共流量：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${commodity.note}</p>
                                    <span class="input-group-btn">
                                  </span>
                            ...
                            <div class="form-group">
                                <label for="search-input">剩余流量：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${commodity.note - data}</p>
                                    <span class="input-group-btn">
                                  </span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="search-input">使用地址：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${address}</p>
                                    <span class="input-group-btn">
                                  </span>
                            ...
                            <div class="form-group">
                                <label for="search-input">卡状态：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${status}</p>
                                    <span class="input-group-btn">
                                  </span>
                            ...
                            <div class="form-group">
                                <label for="search-input">反馈内容：</label>
                                <div class="input-group" style="width:100%;">
                                    <p>${feedback.note}</p>
                                    <span class="input-group-btn">
                                  </span>
                            ...
                            <div class="form-group">
                                <label for="search-input">操作：</label>
                                <div class="input-group" style="width:100%;">
                                    <div style="margin: 10px;">
                                        <a style=" margin: 5px; float: left;width: 45%;" class="btn btn-s-md btn-default" href="javascript:genggai(1)">开机</a>
                                        <a style="margin: 5px;float: left;width: 45%;" class="btn btn-s-md btn-default" href="javascript:genggai(0)">停机</a>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="search-input">回复内容：</label>
                                <div class="input-group" style="width:100%;">
                                    <input type="hidden" name="id" id="id" value="${feedback.id}" >
                                    <textarea class="form-control" rows="3" name="notice" id="note2" >${feedback.note2}</textarea>
                                    <span class="input-group-btn">
                                  </span>
                                </div>
                            </div>
...
<script type="text/javascript">
    function save() {
        var note = $("#note2").val();
        var id = $("#id").val();
        window.location.href = "/admin/feedbackEdit?id="+id+"&note="+note;
    }
    function genggai(status) {
        $.post("/admin/status",{i:'${feedback.aid}',t:status},function (res) {
            if(res == -100){
                alert("操作失败，该卡的套餐已经过期，或者已经用超！");
            }else{
                alert("操作成功"+res);
            }
        });
