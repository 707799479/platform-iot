...
<div class="hui-wrap">
  ...
  <div style="display: flex;" id="btnList1">
    ...
    <c:if test="${pclass.is30 == 1}">
      <button style="width: 50%;margin: 10px;" onclick="dinggou('now')" type="button" class="hui-button hui-button-large hui-primary" >订购为当月</button>
      <button style="width: 50%;margin: 10px;" onclick="dinggou('down')" type="button" class="hui-button hui-button-large hui-primary" >订购为次月</button>
    </c:if>

    <c:if test="${pclass.is30 != 1}">
      <button style="width: 100%;margin: 10px;" onclick="dinggou('now')" type="button" class="hui-button hui-button-large hui-primary" >订购为当月</button>
    </c:if>
  </div>
