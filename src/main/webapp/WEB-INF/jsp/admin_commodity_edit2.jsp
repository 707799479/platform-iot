                            ...
                            <form id="addForm" action="/admin/editCommodity" method="post" enctype="multipart/form-data">
                                <c:if test="${user_agent.parentId == 0}" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="width:100%;">
                                            <input oninput="document.getElementById('ll').innerText = document.getElementById('note').value * ${config.number};" value="${temp_commodity.note}" name="note" type="number" id="note" class="form-control">
                                            <span class="input-group-btn">
                                        </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="width:100%;">
                                            <p id="ll">${temp_commodity.note * config.number}</p>
                                            <span class="input-group-btn">
                                  </span>
                                        </div>
                                    </div>
                                ...
                                <c:if test="${user_agent.parentId != 0}">
                                    ...
                                    <a style="width: 100%;" class="btn btn-s-md btn-default" href="javascript:saveCommodityTwo()">保存</a>
                                </c:if>
                            </form>
                        </div>
