...
<div class="wrapper">
    ...
    <div id="side-nav">
      <ul id="nav">
        ...
        <li> <a href="#"> <i class="icon-money"></i>提现<i class="arrow icon-angle-left"></i></a>
          <ul class="sub-menu">
            <li class="current"> <a href="/admin/extract"> <i class="icon-angle-right"></i>申请提现</a> </li>
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">申请提现<small>您可以在这里提现哦</small></h2>
        </div>
      </div>
      <div class="row">
        <div class="widget">
              ...
              <div class="body">
                <div>
                  <div class="form-group">
                    ...
                    <a class="btn btn-s-md btn-default" href="javascript:go(${user_agent.id})">申请提现</a>
                </div>
              </div>
