...
<div class="hui-wrap">
  ...
  <div style="padding:0px 20px 0px 20px;" id="btnList1">
    ...
    <button onclick="check()" type="button" class="hui-button hui-button-large hui-primary" >付款</button>
  </div>
    </c:if>
    ...
    WeixinJSBridge.invoke(
        ...
        function(res){
            if(res.err_msg == "get_brand_wcpay_request:ok" ){
              ...
              <c:if test="${diy != null}">
                window.location.href = 'http://${domain}.${domain2}/success.html?d=t';
              </c:if>
              <c:if test="${diy == null}">
              window.location.href = 'http://${domain}.${domain2}/success.html';
              </c:if>
            }
        });
    }
